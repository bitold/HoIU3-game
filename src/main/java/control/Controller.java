...
public class Controller implements Serializable {
    ...
    public Controller(GameMap gameMap, Game game){
        ...
        this.game = game;
        this.controllerMenu = new ControllerMenu(this);
    }
    ...
    void printMoveMenu(){
        System.out.println("""
                ...
                -1     1
                    2  \s""");
        System.out.println("/PASS - полностью пропустить ход");
        System.out.println("/PICK - выбрать другого юнита");
    ...
    public boolean processInput(String input){
        ...
        if (input.equals("/MENU")){
            game.getGameMenu().mainMenuCycle(owner.getNickname());
            return true;
        }
