...
public class Game implements Serializable {
    ...
    public void gameRelocationEventsHandler(Entity entity, Coordinates oldcoords, Coordinates coordinates){
        if (this.getVortex().isActive()){
            vortex.swirl(entity, oldcoords, coordinates);
        }
    }

    public SpaceVortex getVortex() {
        return vortex;
    }

    void eventHandler(){
        if (!vortex.isActive()){
            vortex.tryToRandomlyStart();
        } else {
            vortex.completeIteration();
        }
    }
    ...
    public boolean checkEndgame(Player player){
    ...
    public void setCurrentlyMoving(Player currentlyMoving) {
